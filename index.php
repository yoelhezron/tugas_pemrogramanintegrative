...
if($_SESSION['id']==""){
 ...
 <?php  
$cid=$_SESSION['id'];
$ceksess=mysqli_query($conn, "SELECT * FROM loginku where id='$cid'");
...
<span class="focus-input100" data-symbol="&#xf190;"></span>
     ...
     <div class="flex-c-m">
      <a href="https://www.facebook.com/yoelicious/" class="login100-social-item bg1">
      ...
      <a href="https://www.instagram.com/yoelhezron/" class="login100-social-item bg3">
