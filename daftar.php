...
<?php
 ...
 $cek = mysqli_query($conn, "SELECT * FROM loginku where username='$username'");
...
<script type="text/javascript">
 ...
 alert("Maaf\nUsername Telah Digunakan!!!");
      ...
      $query = mysqli_query($conn, "INSERT INTO loginku (fname, username, password) VALUES ('$fname', '$username', '$pass')");
